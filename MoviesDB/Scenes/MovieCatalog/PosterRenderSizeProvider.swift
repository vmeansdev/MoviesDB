...
@MainActor
protocol PosterRenderSizeProviding {
    func size(for containerSize: CGSize, columns: Int, itemHeight: CGFloat, minimumColumns: Int) -> CGSize
}

@MainActor
final class PosterRenderSizeProvider: PosterRenderSizeProviding {
    private var portraitSize: CGSize?
    private var landscapeSize: CGSize?

    func size(for containerSize: CGSize, columns: Int, itemHeight: CGFloat, minimumColumns: Int = 1) -> CGSize {
